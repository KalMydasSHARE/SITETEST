...
const I18N_EN = {
  ...
  sec_1_p: `22 core <span class="g-term" data-g="solidity">Solidity</span> contracts (deployed across 26 instances including 5 strategy pools), public source code, verifiable on <span class="g-term" data-g="arbiscan">Arbiscan</span> at any time`,
  ...
  road_2_p: `22 core Solidity contracts deployed on <span class="g-term" data-g="arbitrum_sepolia">Arbitrum Sepolia</span> (26 instances including 5 strategy pools). veKAL, governance, referral system, auto-compound, performance diversifier, RWA treasury, individual solo mode per strategy — all coded and tested. 3rd consecutive Omniscient PASS (final retest on April 22, 300,000-transition fuzz, KalPool individual pause validated on April 25 — GO Sepolia redeployment on May 3). Beta testing program active.`,
  ...
  public_p: "7 tiers open to everyone, no whitelist. Combined cap 332,500 KAL = $1,435,000 maximum raised. Conditional on minimum $75k raised in Alpha + Beta by August 31.",
